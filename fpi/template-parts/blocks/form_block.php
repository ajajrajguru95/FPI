...
?>
    ...
    <section class="form-section default-form  py-[6.25rem] px-16 max-xl:px-5 max-md:py-12 bg-lightblue" style="<?php if ($padding_top) { ?>padding-top: <?= $padding_top ?>px; <?php } ?><?php if ($padding_bottom) { ?>padding-bottom: <?= $padding_bottom ?>px <?php } ?>" id="form-block">
