...
?>
    ...
    <?php if (!wp_is_mobile()) { ?>
        ...
        <section class="sticky-img-block desktop pt-[10rem]  pb-[14rem]  max-md:py-12  fade-in <?= (!$transparent_background) ? 'bg-aliceblue' : ''; ?>" data-delay="0.2" style="<?php if ($padding_top) { ?>padding-top: <?= $padding_top ?>px; <?php } ?><?php if ($padding_bottom) { ?>padding-bottom: <?= $padding_bottom ?>px <?php } ?>">
            ...
            <div class=" w-full   px-16 max-xl:px-5 pb-[12rem]">
                <?php if ($sub_title) : ?>
    ...
    <?php } else { ?>
        ...
        <section class="img-content-block mob-tablet py-[6.25rem] max-md:py-12 px-16 max-xl:px-5  fade-in  flex-col gap-5 <?= (!$transparent_background) ? 'bg-aliceblue' : ''; ?>">
            <?php
            ...
            ?>
                ...
                <a class="item-block flex gap-10 max-md:gap-5 max-md:flex-col cursor-default pb-5 last:pb-0 last:border-0 border-b border-[#0000001A]" href="javascript:void(0);">

                    <div class="flex col flex-col">
                        <p class="text-xl font-medium leading-6 text-black">0<?= $key + 1; ?></p>
                        <?php if ($title) : ?>
                        ...
                        <?php endif; ?>
                        <div class="flex my-5">
                            <img data-src="<?= $thumbnail['url']; ?>" class="object-cover w-full  aspect-[0.875]   lazy-image" />
                        </div>
                        <?php if ($desc) : ?>
                            <p class="max-md:mt-4 text-lg max-md:text-base leading-7 text-black sl:line-clamp-5">
                                <?= $desc; ?>
                            </p>
                        <?php endif; ?>
