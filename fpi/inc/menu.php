...
function transient_footerMenu($menu_location)
{
    ...
    if (!$footer_menu) {
        $menu_args = array(
            ...
            'container' => 'nav',
            'menu_class' => 'flex flex-col grow text-2xl leading-6 text-white whitespace-nowrap  prose prose-a:text-[1.5rem] max-md:prose-a:text-[1.25rem]  prose-a:text-white prose-a:no-underline prose-a:mb-6 prose-a:font-normal max-md:prose-a:mb-4 prose-a:transition-all prose-a:duration-700 [&>a:hover]:opacity-50',
            'echo' => false,
