...
/* harmony export */   "default": () => (/* binding */ BlockMain)
/* harmony export */ });
/* harmony import */ var _ListingBlock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ListingBlock */ "./src/js/Blocks/ListingBlock.js");
...
var BlockMain = /*#__PURE__*/_createClass(function BlockMain() {
  var _this = this;
  _classCallCheck(this, BlockMain);
  _defineProperty(this, "setDomMap", function () {
    _this.listingBlock = $(".listing--block");
  ...
  _defineProperty(this, "initComponents", function () {
    if (_this.listingBlock.length) {
      new _ListingBlock__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  });
  this.setDomMap();
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ListingBlock)
/* harmony export */ });
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var ListingBlock = /*#__PURE__*/_createClass(function ListingBlock() {
  var _this = this;
  _classCallCheck(this, ListingBlock);
  _defineProperty(this, "bindEvents", function () {
    _this.keywords.keyup(_this.delayLoad);
    _this.dynamicFilters.on("change", _this.filterSearch);
    _this.sortFilter.on("change", _this.filterSearch);
    _this.initiatePagination();
  });
  ...
  _defineProperty(this, "initiatePagination", function () {
    if (_this.loadMore.length) {
      var paginationStyle = _this.loadMore.attr("data-pagination-style");
      if (paginationStyle === "on_scroll") {
        _this.autoLoad = _this.loadMore.attr("data-load-more");
        _this.toggleLoadMore = function (flag) {
          _this.autoLoad = !!flag;
        };
        $(window).scroll(_this.windowScroll);
      } else if (paginationStyle === "on_click") {
        _this.toggleLoadMore = function (flag) {
          flag ? _this.loadMore.show() : _this.loadMore.hide();
        };
        _this.loadMore.on("click", _this.nextPage);
      }
    }
  });
  _defineProperty(this, "windowScroll", function () {
    if (_this.autoLoad && _this.isAtBottom()) {
      _this.autoLoad = false;
      _this.nextPage();
    }
  });
  _defineProperty(this, "isAtBottom", function () {
    var scroll = _this.block.scrollTop() + _this.block.innerHeight() + 100;
    var scrollHeight = _this.block[0].scrollHeight;
  ...
  _defineProperty(this, "formParams", function () {
    var data = {};
    data["keywords"] = _this.keywords.val();
    data["page"] = _this.page;
    data["ccm_token"] = _this.ccmToken.val();
    if (_this.sortFilter.length) data[_this.sortFilter.attr("name")] = _this.sortFilter.val();
    _this.dynamicFilters.each(function (index, item) {
      item = $(item);
      var key = item.attr("name");
      var values = item.val();
      data[key] = Array.isArray(values) ? values.map(function (value) {
        return encodeURIComponent(value);
      }) : [encodeURIComponent(values)];
    });
    return data;
  });
  _defineProperty(this, "clearContainer", function () {
    _this.bindData.empty();
  });
  ...
  _defineProperty(this, "filterSearch", function () {
    _this.resetPage();
  ...
  _defineProperty(this, "requestData", function () {
    $.ajax({
      dataType: "json",
      type: "GET",
      cache: false,
  ...
  _defineProperty(this, "appendItems", function (response) {
    _this.bindData.append(response.data);
    _this.hideLoader();
    _this.toggleLoadMore(response.loadMore);
  });
  _defineProperty(this, "setHistory", function () {
    if (window.history.pushState) {
      var url = '?';
      var params = '';
      var data = _this.formParams();
      for (var key in data) {
  ...
  _defineProperty(this, "handleError", function (e) {
...
var freeSlider = $(".free-slider");
var newsSlider = $(".news-slider");
var overflowSlider = $(".overflow-slider");
var sliderOneItemPerView = $(".overflow-slider-one-item");
var fadeProgressSlider = $(".fade-progress-slider");
var tabSlider = $(".tab-section-block");
var numberBlock = $(".number-block-wrap");
var lazy = $(".lazy-image,.lazy-video");
var fancyBoxModal = $(".fancy-box");
var bannerSlider = $(".banner-slider");
var horizontalMovement = $(".h-movement");
var parallaxUp = $(".parallax-block-wrap");
//const heightBlock = $(".h-block");
var stickyAnimBlock = $(".sticky-anim-block");
var productGallery = $(".product-gallery");
var cursorCustom = $(".show-cursor");
var pageNavSlider = $(".page-nav-slider");
var stickyImageBlock = $(".sticky-img-block");
// const readMoreBlock = $(".read-more-block");
var accordionBlock = $(".accordion-block");
var lottieAnimations = $(".icon-animation");
var gallerySlider = $(".gallery-slider");
var hoverDescSlide = $(".hover-slide-block");
var selectDrop = $("select:not(.no-select2)");
var copyToClipClick = $(".js-copy-clipboard");
var certificateSlider = $(".certificate-slider");
var timeline = $(".timeline-block");
var enquiryFormPopUp = $(".form-pop-up");
var applyFormPopUp = $(".form-apply-pop-up");
// Set 'mobile' to false to prevent JS from loading on mobile. Change the media query as desired in DynamicImports.js

//listing
var relevantProducts = $(".relevant-products");
var commonListing = $(".common-listing");
var accreditationsListing = $(".accreditations-list");
var search = $(".search-page");
var productListing = $(".product-listing");
var test = $('.home-banner');
var componentList = [{
...
var Animation = /*#__PURE__*/_createClass(function Animation() {
  ...
  _defineProperty(this, "fadeInAnimation", function () {
    ...
    if (fadeIn.length) {
      fadeIn.forEach(function (container) {
        var fadeInTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
          scrollTrigger: {
            trigger: container,
            start: "50px bottom"
          }
  ...
  // fade Up
  _defineProperty(this, "fadeUpAnimation", function () {
    var fadeUp = document.querySelectorAll(".fade-up");
    if (fadeUp.length) {
      fadeUp.forEach(function (container) {
        var fadeUpTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
          scrollTrigger: {
            trigger: container,
            start: "15% 100%"
          }
  ...
  //Parallax
  _defineProperty(this, "parallaxAnimation", function () {
    var parallax = document.querySelectorAll(".parallax-item");
    if (parallax.length) {
      parallax.forEach(function (container) {
        var parallaxTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
          scrollTrigger: {
            trigger: container,
            start: "top bottom",
            scrub: 1,
  ...
  _defineProperty(this, "fadeUpStagger", function () {
    var fadeUpWrapper = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".fade-up-stagger-wrap");
    if (fadeUpWrapper.length) {
      fadeUpWrapper.forEach(function (fadeUpWrap) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(fadeUp, {
          scrollTrigger: {
            trigger: fadeUpWrap,
            start: "5% 100%"
          },
    ...
    if (_componentList__WEBPACK_IMPORTED_MODULE_1__.componentList) {
      $.each(_componentList__WEBPACK_IMPORTED_MODULE_1__.componentList, function (_, _ref) {
        var el = _ref.element,
          ...
          mobile = _ref.mobile;
        if (!mobile && _utils__WEBPACK_IMPORTED_MODULE_0__.max767.matches) return;
...
var Header = /*#__PURE__*/_createClass(function Header(_ref) {
  ...
  _defineProperty(this, "bindEvents", function () {
    ...
    var levelOneListArrow = $(".mobile-nav .mobile-menu-list > ul > li > .nav-item > span");
    var levelOneList = $(".mobile-nav .mobile-menu-list > ul > li");
    var levelTwo = $(".mobile-nav .mobile-menu-list > ul > li > ul");
    var levelTwoList = $(".mobile-nav .mobile-menu-list > ul > li > ul > li");
    var levelTwoListArrow = $(".mobile-nav .mobile-menu-list > ul > li > ul > li > .nav-item > span");
    var levelThree = $(".mobile-nav .mobile-menu-list > ul > li > ul .sub-nav-wrap");
    var backButton = $(".mobile-nav .back-to");
    ...
    // Main menu hover
    _this.mainNav.hover(function (_ref2) {
      var currentTarget = _ref2.currentTarget;
      _this.mainNav.removeClass("active");
      _this.htmlBody.removeClass("active");
      _this.htmlBody.addClass("menu-active");
      currentTarget.classList.add("active");
      _this.hamMenu.removeClass('active');
      _this.mobileMenu.removeClass('active');
    }, function (_ref3) {
      var currentTarget = _ref3.currentTarget;
    });
    var hideMegaMenu = function hideMegaMenu() {
      _this.htmlBody.removeClass("menu-active");
      _this.mainNav.removeClass("active");
    };

    // Mega menu hover
    _this.megaMenu.hover(function (_ref4) {
      var currentTarget = _ref4.currentTarget;
    }, function (_ref5) {
      var currentTarget = _ref5.currentTarget;
      hideMegaMenu();
    });
    _this.header.hover(function (_ref6) {
    ...
    // otherLinks hover
    var otherLinks = $("#menu-main-menu-header-1 > li:not(.menu-item-has-children),.mobile-menu,.make-enquiry,.search-btn,.logo");
    otherLinks.hover(function (_ref8) {
    ...
    // Hover image update
    var hoverTimeout;
    $container.on('mouseenter', 'a[data-hover-image]', function (_ref10) {
      var currentTarget = _ref10.currentTarget;
      var hoverImageSrc = currentTarget.getAttribute('data-hover-image');
      // Clear any previous timeout
      clearTimeout(hoverTimeout);
      _this.imageHover.removeClass('active');
      hoverTimeout = setTimeout(function () {
        _this.imageHover.attr('src', hoverImageSrc);
        _this.imageHover.addClass('active');
      }, 300); // Adjust the delay time as needed
    });
    $container.on('mouseleave', 'a[data-hover-image]', function (_ref11) {
    ...
    $(window).on('scroll', function () {
      if (_this.htmlBody.hasClass('menu-active')) {
        _this.htmlBody.removeClass('menu-active');
        _this.mainNav.removeClass("active");
        _this.hamMenu.removeClass('active');
      }
      if (_this.hamMenu.hasClass('active')) {
        _this.htmlBody.removeClass("active");
        _this.hamMenu.removeClass('active');
        _this.mobileMenu.removeClass('active');
      }
  ...
  _defineProperty(this, "handleMobileMenu", function () {
    if (_this.mobileMenu.hasClass('active')) {
      ...
      if (window.innerWidth < 1200) {
        _this.htmlBody.removeClass('no-scroll');
      }
    } else {
      ...
      _this.hamMenu.addClass('active');
      _this.htmlBody.removeClass("menu-active");
      _this.mainNav.removeClass("active");
      if (window.innerWidth < 1200) {
        _this.htmlBody.addClass('no-scroll');
      }
    }
  });
  this.header = header;
...
var Maps = /*#__PURE__*/function () {
  function Maps(async_google) {
    var _this = this;
    _classCallCheck(this, Maps);
    _defineProperty(this, "init", function (google, mapContainer) {
      _this.mapCenter = new google.LatLng(15, 75);
      _this.map = new google.Map(mapContainer, _objectSpread(_objectSpread({}, (0,_constants__WEBPACK_IMPORTED_MODULE_1__.mapOptions)(google)), {
...
/***/ "./src/js/components/Maps/types/ContactMap.js":
/*!****************************************************!*\
  !*** ./src/js/components/Maps/types/ContactMap.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ContactMap)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .. */ "./src/js/components/Maps/index.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var ContactMap = /*#__PURE__*/_createClass(function ContactMap() {
  var _this = this;
  ...
  ___WEBPACK_IMPORTED_MODULE_0__["default"].loadGoogleApi().then(function (map) {
    _this.google = map.google;

    // Iterate over each map_contact element
    _this.$mapBlocks.each(function (index, mapBlock) {
      var mapInstance = map.init(_this.google, mapBlock); // Initialize map for each element
      _this.maps.push(mapInstance); // Store the map instance
      var $mapBlock = $(mapBlock); // Convert mapBlock to jQuery object

      var defaultIcon = {
        url: _this.themeUrl + "/assets/images/marker.svg",
        origin: new _this.google.Point(0, 0),
        anchor: new _this.google.Point(15, 15)
      };
      var activeIcon = {
        url: _this.themeUrl + "/assets/images/marker-active.svg",
        origin: new _this.google.Point(0, 0),
        anchor: new _this.google.Point(15, 15)
      };
      ...
      $mapBlock.siblings(".map-coordinates").find(".coordinates").toArray().reverse().forEach(function (coordinate, index, arr) {
        var $coordinate = $(coordinate);
        var icon = index === arr.length - 1 ? activeIcon : defaultIcon; // Set active icon for the first item
        var marker = new _this.google.Marker({
          position: {
            lat: parseFloat($coordinate.attr("data-lat")),
            lng: parseFloat($coordinate.attr("data-lng"))
          },
          map: mapInstance,
          animation: _this.google.Animation.DROP,
          icon: icon,
      ...
      var setIconAndCenterMap = function setIconAndCenterMap(latitude) {
      ...
      $mapBlock.parents().find(".location-item h3").on("click", function (event) {
        var item = $(this).closest(".location-item").attr("data-lat");
        var lat = parseFloat(item);
        setIconAndCenterMap(lat);
      });
      $mapBlock.parents().find(".free-slider .swiper-slide").on("click", function (event) {
        setTimeout(function () {
          var activeSlide = $mapBlock.parents().find(".tab-content .swiper-slide-active .active");
          var latitude = parseFloat(activeSlide.attr("data-lat"));
...
/* harmony export */   isInViewportOffset: () => (/* binding */ isInViewportOffset),
/* harmony export */   isMobileAndTablet: () => (/* binding */ isMobileAndTablet),
...
var isInViewportOffset = function isInViewportOffset(element) {
  if (element.length) {
    var flag = false;
    element.each(function (_, el) {
      var elementTop = element.offset().top - 800;
...
var lazyLoad = function lazyLoad(element) {
  ...
  element.each(function (index, e) {
    ...
    if ($this.hasClass("lazy-bg")) {
      $this.removeClass("lazy-bg lazy desk-lazy").removeAttr("data-src").css({
      ...
      if (mobile && $(window).width() < 768) {
        ...
        $this.removeClass("lazy desk-lazy").removeAttr("data-src").attr("src", src);
      }
    }
...
var isMobileAndTablet = function isMobileAndTablet() {
  var check = false;
  (function (a) {
...
var map = {
	...
	"./Accreditations": [
		"./src/js/components/Accreditations.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"Listing",
		"Accreditations"
	],
	"./Accreditations.js": [
	...
	"./ApplyPopUpBlock": [
		"./src/js/components/ApplyPopUpBlock.js",
		"ApplyPopUpBlock"
	],
	"./ApplyPopUpBlock.js": [
		"./src/js/components/ApplyPopUpBlock.js",
	...
	"./BannerSlider": [
		...
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"vendors-node_modules_gsap_SplitText_js",
		"BannerSlider"
	],
	"./BannerSlider.js": [
		"./src/js/components/BannerSlider.js",
	...
	"./BannerSliderCheck": [
		"./src/js/components/BannerSliderCheck.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"vendors-node_modules_gsap_SplitText_js",
		"BannerSliderCheck"
	],
	"./BannerSliderCheck.js": [
		"./src/js/components/BannerSliderCheck.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"vendors-node_modules_gsap_SplitText_js",
	...
	"./CertificateSlider": [
		"./src/js/components/CertificateSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"CertificateSlider"
	],
	"./CertificateSlider.js": [
		"./src/js/components/CertificateSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"CertificateSlider"
	...
	"./CommonListing": [
		"./src/js/components/CommonListing.js",
		"Listing",
		"CommonListing"
	],
	"./CommonListing.js": [
	...
	"./CursorCustom": [
		"./src/js/components/CursorCustom.js",
		"CursorCustom"
	],
	"./CursorCustom.js": [
		"./src/js/components/CursorCustom.js",
	...
	"./EnquiryPopUpBlock": [
		"./src/js/components/EnquiryPopUpBlock.js",
		"EnquiryPopUpBlock"
	],
	"./EnquiryPopUpBlock.js": [
		"./src/js/components/EnquiryPopUpBlock.js",
		"EnquiryPopUpBlock"
	],
	"./FadeProgressSlider": [
		"./src/js/components/FadeProgressSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"FadeProgressSlider"
	],
	"./FadeProgressSlider.js": [
		"./src/js/components/FadeProgressSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"FadeProgressSlider"
	...
	"./FancyBoxModal": [
		"./src/js/components/FancyBoxModal.js",
		"vendors-node_modules_fancyapps_ui_dist_index_esm_js-node_modules_fancyapps_ui_dist_fancybox_f-306b87",
		"FancyBoxModal"
	],
	"./FancyBoxModal.js": [
		"./src/js/components/FancyBoxModal.js",
	...
	"./FreeSlider": [
		"./src/js/components/FreeSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"FreeSlider"
	],
	"./FreeSlider.js": [
	...
	"./HeightCheck": [
		"./src/js/components/HeightCheck.js",
		"HeightCheck"
	],
	"./HeightCheck.js": [
		"./src/js/components/HeightCheck.js",
	...
	"./HoverDescSlide": [
		"./src/js/components/HoverDescSlide.js",
		"HoverDescSlide"
	],
	"./HoverDescSlide.js": [
		"./src/js/components/HoverDescSlide.js",
	...
	"./LottieAnimations": [
		"./src/js/components/LottieAnimations.js",
	...
	"./Maps/types/ContactMap": [
		"./src/js/components/Maps/types/ContactMap.js"
	],
	"./Maps/types/ContactMap.js": [
		"./src/js/components/Maps/types/ContactMap.js"
	],
	"./NewsSlider": [
	...
	"./NumberTab": [
		"./src/js/components/NumberTab.js",
		"NumberTab"
	],
	"./NumberTab.js": [
		"./src/js/components/NumberTab.js",
	...
	"./OverflowSlider": [
		"./src/js/components/OverflowSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"OverflowSlider"
	],
	...
	"./ProductGallery": [
		"./src/js/components/ProductGallery.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"ProductGallery"
	],
	...
	"./ProductListing": [
		"./src/js/components/ProductListing.js",
		"Listing",
		"ProductListing"
	],
	"./ProductListing.js": [
	...
	"./RelevantProducts": [
		"./src/js/components/RelevantProducts.js",
		"Listing",
		"RelevantProducts"
	],
	"./RelevantProducts.js": [
	...
	"./SelectDrop": [
		"./src/js/components/SelectDrop.js",
		"vendors-node_modules_select2_dist_css_select2_css-node_modules_select2_dist_js_select2_js",
		"SelectDrop"
	],
	"./SelectDrop.js": [
		"./src/js/components/SelectDrop.js",
	...
	"./SliderOneItemPerView": [
		"./src/js/components/SliderOneItemPerView.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"SliderOneItemPerView"
	],
	"./SliderOneItemPerView.js": [
		"./src/js/components/SliderOneItemPerView.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"SliderOneItemPerView"
	],
	"./SolutionSlider": [
		"./src/js/components/SolutionSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"SolutionSlider"
	],
	"./SolutionSlider.js": [
	...
	"./StickyAnimBlock": [
		"./src/js/components/StickyAnimBlock.js",
		"StickyAnimBlock"
	],
	"./StickyAnimBlock.js": [
		"./src/js/components/StickyAnimBlock.js",
	...
	"./StickyImageBlock": [
		"./src/js/components/StickyImageBlock.js",
		"StickyImageBlock"
	],
	"./StickyImageBlock.js": [
		"./src/js/components/StickyImageBlock.js",
	...
	"./TabSlider": [
		"./src/js/components/TabSlider.js",
		"vendors-node_modules_swiper_swiper_mjs",
		"vendors-node_modules_swiper_modules_index_mjs",
		"TabSlider"
	],
...
/******/ 			var cssChunks = {"vendors-node_modules_fancyapps_ui_dist_index_esm_js-node_modules_fancyapps_ui_dist_fancybox_f-306b87":1,"vendors-node_modules_intl-tel-input_build_js_intlTelInput_js-node_modules_intl-tel-input_buil-3a9639":1,"vendors-node_modules_select2_dist_css_select2_css-node_modules_select2_dist_js_select2_js":1};
...
/* harmony import */ var _components_Maps_types_ContactMap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Maps/types/ContactMap */ "./src/js/components/Maps/types/ContactMap.js");
/* harmony import */ var _Blocks_BlockMain__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Blocks/BlockMain */ "./src/js/Blocks/BlockMain.js");
/* harmony import */ var _components_DynamicImports__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/DynamicImports */ "./src/js/components/DynamicImports.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new ( /*#__PURE__*/function () {
  function App() {
    ...
    _defineProperty(this, "domReady", function () {
      ...
      _this.initLenis(); // Initialize Lenis
      _this.categorySwitch();
    });
    _defineProperty(this, "initComponents", function () {
      ...
      if (_this.mapContact.length) {
        new _components_Maps_types_ContactMap__WEBPACK_IMPORTED_MODULE_1__["default"]({
          mapContact: _this.mapContact
        });
      }
      new _Blocks_BlockMain__WEBPACK_IMPORTED_MODULE_2__["default"]();
      new _components_DynamicImports__WEBPACK_IMPORTED_MODULE_3__["default"]();
      new _components_Animation__WEBPACK_IMPORTED_MODULE_4__["default"]();
    });
    _defineProperty(this, "captchaLoad", function () {
      $(window).on("scroll load", function () {
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_5__.inVP)(_this.formidable) && !_this.formidable.hasClass("formInview")) {
          _this.formidable.addClass('formInview');
        }
      });
    });
    _defineProperty(this, "setDomMap", function () {
      ...
      _this.mapContact = $('#map_contact');
      _this.formidable = $('.formidable');
      _this.inputs = $('input, textarea').not('[type="checkbox"], [type="radio"]');
      _this.searchBtn = $('.search-btn');
      _this.searchTopBlock = $('.search-top-block');
      _this.searchCloseBtn = $('.search-top-block .close-btn');
    });
    _defineProperty(this, "bindEvents", function () {
      // Window Events
      ...
      _this.searchBtn.on('click', function () {
        _this.searchTopBlock.toggleClass('active');
      });
      _this.searchCloseBtn.on('click', function () {
        _this.searchTopBlock.toggleClass('active');
      });
      ...
      if ($(".no-banner,.error404").length) {
        _this.htmlBody.addClass("blue-header");
      }
    ...
    _defineProperty(this, "windowScroll", function () {
      ...
      _this.header.toggleClass('top', topOffset > 300);
    ...
    _defineProperty(this, "handleUserAgent", function () {
      ...
      var isIPadPro = /Macintosh/i.test(navigator.userAgent) && 'ontouchend' in document;
      if (isIPadPro) {
        // Code for iPad Pro
        _this.htmlBody.addClass("mobile-tablet-device");
        _this.htmlBody.addClass("ipad-pro");
      }
    });
    _defineProperty(this, "initLenis", function () {
    ...
    _defineProperty(this, "categorySwitch", function () {
      var downloadBlock = document.querySelectorAll('.downloads-sections');
      downloadBlock.forEach(function (download) {
        var select = download.querySelector('select');
...
jQuery(function () {
  ...
  jQuery(document).bind('gform_post_render', function (event, form_id, current_page) {
    if (formRenderedOnce[form_id]) {
      ...
      var inputs = jQuery('input, textarea').not('[type="checkbox"], [type="radio"]');
      inputs.bind({
        focus: function focus(e) {
      ...
      var phoneInputs = jQuery('input[type="tel"]');
      var globalIti = null;
      phoneInputs.each(function (i, el) {
        ...
        var dialCode = globalIti.getSelectedCountryData().dialCode;
        jQuery(el).parents(".form-group").find("#" + jQuery(el)[0].id + "-dial-code").val("+" + dialCode);

        //Add country code to hidden input field on country change
        jQuery(el).on("countrychange", function (e) {
          var dialCode = globalIti.getSelectedCountryData().dialCode;
          jQuery(e.currentTarget).parents(".form-group").find("#" + jQuery(el)[0].id + "-dial-code").val("+" + dialCode);
        });

        //Prevent background scroll on mobile
        if (isMobileAndTablet()) {
          jQuery(el).on("open:countrydropdown", function () {
            jQuery("body").addClass("active");
          });
          jQuery(el).on("close:countrydropdown", function () {
...
/******/ })()
;
//# sourceMappingURL=app-1.8.min.js.map